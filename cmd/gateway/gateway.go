...
import (
	...
	// NAS
	_ "github.com/n1chre/minio/cmd/gateway/nas"

	// Azure
	_ "github.com/n1chre/minio/cmd/gateway/azure"

	// S3
	_ "github.com/n1chre/minio/cmd/gateway/s3"

	// HDFS
	_ "github.com/n1chre/minio/cmd/gateway/hdfs"

	// GCS (use only if you must, GCS already supports S3 API)
	_ "github.com/n1chre/minio/cmd/gateway/gcs"
